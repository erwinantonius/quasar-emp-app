<template>
  <q-page padding class="dashboard-page">
    ...
    <div class="row q-col-gutter-lg">
      <!-- User Profile Card -->
      <div class="col-12">
        <q-card class="gradient-card user-card animate-card">
      ...
      <!-- Tenant Info Card -->
      <div class="col-12">
        <q-card class="gradient-card tenant-card animate-card">
      ...
      <div class="col-12">
        <q-card class="gradient-card workplace-card animate-card">
      ...
      <div class="col-12">
        <q-card class="gradient-card delegates-card animate-card">
      ...
      <!-- Summary Stats -->
      <div class="col-12">
        <q-card class="gradient-card stats-card animate-card">
